...
class _$DriverImpl implements _Driver {
  ...
  @override
  String toString() {
    return 'Driver(id: $id, namaLengkap: $namaLengkap, alamat: $alamat, nik: $nik, nokk: $nokk, noHp: $noHp, noPlatMobil: $noPlatMobil, maxPenumpang: $maxPenumpang, fotoKtp: $fotoKtp, fotoMobil: $fotoMobil, user: $user)';
  }
